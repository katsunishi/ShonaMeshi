    ...
    <div className="contact">
      ...
      <div className="introduce">
        ...
        <div className="introText">
          当サイトを制作、運営しているNissyと申します。大学生から始めたプログラミングをどうすれば、誰かのために活かせるか考えている際、学生団体の先輩からアイデアをいただき約1週間の開発期間を経てリリースすることができました。まだまだ実力不足ではありますが、これからも少しでも多くの人にショナメシの魅力がさらに広がりますよう開発者として努めてまいります。
        </div>
      </div>
    </div>
  );
